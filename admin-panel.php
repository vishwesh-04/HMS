    ...
    if ((date("Y-m-d", $appdate1) == $cur_date and date("H:i:s", $apptime1) > $cur_time) or date("Y-m-d", $appdate1) > $cur_date) {
      ...
      if (mysqli_num_rows($check_query) == 0) {
        ...
        echo "<script>document.addEventListener('DOMContentLoaded', ()=>{
          toastr.error('We are sorry to inform that the doctor is not available in this time or date. Please choose different time or date!');
        })
      ...
      echo "<script>document.addEventListener('DOMContentLoaded', ()=>{
          toastr.warning('Select a time or date in the future!');
        })
  ...
  if ($query) {
    echo "<script>
        document.addEventListener('DOMContentLoaded', function () {
            toastr.success('Your appointment has been successfully cancelled.');
        });
    </script>";
}
...
if (isset($_GET["generate_bill"])) {
  ...
  $content .= '
      <br/>
      <h2 align ="center"> MediCare</h2></br>
...
<body>
  ...
  <div class="container-fluid vh-100 p-4">
    ...
    <div class="row mt-4 pt-4">
      <div class="mb-4 fs-3 text-black">
        Welcome
        &nbsp<?php echo $fname ?>&nbsp<?php echo $lname ?>
      </div>
    </div>
    <div class="row">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) { ?>
                        ...
                        <a href="admin-panel.php?ID=<?php echo $row['ID'] ?>&cancel=update" onClick="event.preventDefault(); Swal.fire({
       title: 'Are you sure?',
    ...
    <input type="hidden" name="generate_bill" value="Pay Bill" />
    <input type="submit" class="btn btn-success" value="Pay Bill"
           ...
           Swal.fire({
               ...
               if (result.isConfirmed) {
                   this.form.submit(); // Submit the form after confirmation
               }
           });" />
</form>
